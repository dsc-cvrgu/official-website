        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-11 col-lg-4 mx-auto my-5">
              <div className="card pb-4 hvr-buzz-out">
                <img
                  src={Aman}
                  alt="aman"
                ...
                <div className="card-body py-3 px-0">
                  ...
                  <div className="card-title">
                    <h5 className="text-center mt-3">DSC Lead</h5>
                  </div>
                </div>
                <div className="team-icons d-flex justify-content-center">
                  <a href="https://www.linkedin.com/in/amanirshad/" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faLinkedin} size="2x" className="linkedin" />
                  </a>
                  <a href="https://www.instagram.com/amanirshad7/" target="_blank" rel="noopener noreferrer">
      ...
      <section id="team" className="my-4">
        <div className="container">
          ...
          <div className="row">
            <div className="col-11 col-lg-4 mx-auto my-5">
              <div className="card pb-4 hvr-buzz-out">
                <img src={Ritesh} alt="alt" className="mx-auto img-fluid rounded-circle mb-2 mt-3 z-depth-1" />
                <div className="card-body py-3 px-0">
                ...
                <div className="team-icons d-flex justify-content-center">
                  <a href="https://www.linkedin.com/in/ritesh-kumar-sinha-8558861a7/" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faLinkedin} size="2x" className="linkedin" />
                  </a>
                  <a href="https://www.instagram.com/riteshsinha70/" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faInstagram} size="2x" className="instagram" />
                  </a>
                  <a href="https://twitter.com/Riteshk86822970?s=08" target="_blank" rel="noopener noreferrer"                    >
            ...
            <div className="col-11 col-lg-4 mx-auto my-5">
              <div className="card pb-4 hvr-buzz-out">
                <img src={Deepak} alt="alt" className="mx-auto img-fluid rounded-circle mb-2 mt-3 z-depth-1" />
                <div className="card-body py-3 px-0">
                ...
                <div className="team-icons d-flex justify-content-center">
                  <a href="https://www.linkedin.com/in/deepak-kumar-sahoo-59247b19a/" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faLinkedin} size="2x" className="linkedin" />
                  </a>
                  <a href="https://www.instagram.com/_.deepak._988/" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faInstagram} size="2x" className="instagram" />
                  </a>
                  <a href="https://twitter.com/DEEPAKK60928454" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faTwitter} size="2x" className="twitter" />
                  </a>
                </div>
              </div>
            ...
            <div className="col-11 col-lg-4 mx-auto my-5">
              <div className="card pb-4 hvr-buzz-out">
                <img src={Saumya} alt="alt" className="mx-auto img-fluid rounded-circle mb-2 mt-3 z-depth-1" />
                <div className="card-body py-3 px-0">
                ...
                <div className="team-icons d-flex justify-content-center">
                  <a href="https://www.linkedin.com/in/saumya-srivastava-703bb31ab/" target="_blank" rel="noopener noreferrer" >
                    <FontAwesomeIcon icon={faLinkedin} size="2x" className="linkedin" />
                  </a>
                  <a href="https://www.instagram.com/saumya3215/" target="_blank" rel="noopener noreferrer" >
                    <FontAwesomeIcon icon={faInstagram} size="2x" className="instagram" />
                  </a>
            ...
            <div className="col-11 col-lg-4 mx-auto my-5">
              <div className="card pb-4 hvr-buzz-out">
                <img src={Ippsa} alt="alt" className="mx-auto img-fluid rounded-circle mb-2 mt-3 z-depth-1" />
                <div className="card-body py-3 px-0">
                ...
                <div className="team-icons d-flex justify-content-center">
                  ...
                  <a href="https://twitter.com/asppi2806" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faTwitter} size="2x" className="twitter" />
                  </a>
                </div>
              </div>
            ...
            <div className="col-11 col-lg-4 mx-auto my-5">
              <div className="card pb-4 hvr-buzz-out">
                <img src={Anita} alt="alt" className="mx-auto img-fluid rounded-circle mb-2 mt-3 z-depth-1" />
                <div className="card-body py-3 px-0">
                ...
                <div className="team-icons d-flex justify-content-center">
                  <a href="https://www.linkedin.com/in/anitakumarijena/" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faLinkedin} size="2x" className="linkedin" />
                  </a>
                  <a href="https://www.instagram.com/___ani_jena_714___/" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faInstagram} size="2x" className="instagram" />
                  </a>
                  <a href="https://twitter.com/AnitakumariJen1" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faTwitter} size="2x" className="twitter" />
                  </a>
                </div>
              </div>
            ...
            <div className="col-11 col-lg-4 mx-auto my-5">
              <div className="card pb-4 hvr-buzz-out">
                <img src={Snata} alt="alt" className="mx-auto img-fluid rounded-circle mb-2 mt-3 z-depth-1" />
                <div className="card-body py-3 px-0">
                ...
                <div className="team-icons d-flex justify-content-center">
                  <a href="https://www.linkedin.com/in/snata-gayan-5b349b19b/" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faLinkedin} size="2x" className="linkedin" />
                  </a>
                  <a href="https://www.instagram.com/s.n.a.t.a_/" target="_blank" rel="noopener noreferrer" >
                    <FontAwesomeIcon icon={faInstagram} size="2x" className="instagram" />
                  </a>
      ...
      <section id="team" className="my-4">
        <div className="container">
          ...
          <div className="row">
            <div className="col-11 col-lg-4 mx-auto my-5">
              <div className="card pb-4 hvr-buzz-out">
                <img src={Atman} alt="alt" className="mx-auto img-fluid rounded-circle mb-2 mt-3 z-depth-1" />
                <div className="card-body py-3 px-0">
                ...
                <div className="team-icons d-flex justify-content-center">
                  <a href="https://www.linkedin.com/in/atmanad/" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faLinkedin} size="2x" className="linkedin" />
                  </a>
                  <a href="https://www.instagram.com/__ghost_1/" target="_blank" rel="noopener noreferrer" >
                    <FontAwesomeIcon icon={faInstagram} size="2x" className="instagram" />
                  </a>
                </div>
              </div>
            ...
            <div className="col-11 col-lg-4 mx-auto my-5">
              <div className="card pb-4 hvr-buzz-out">
                <img src={Sidharth} alt="alt" className="mx-auto img-fluid rounded-circle mb-2 mt-3 z-depth-1" />
                <div className="card-body py-3 px-0">
                ...
                <div className="team-icons d-flex justify-content-center">
                  <a href="https://www.linkedin.com/in/sidharth-bhunia-563852190" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faLinkedin} size="2x" className="linkedin" />
                  </a>
                  {/* <a href="" target="_blank">
                      <FontAwesomeIcon
            ...
            <div className="col-11 col-lg-4 mx-auto my-5">
              <div className="card pb-4 hvr-buzz-out">
                ...
                <div className="team-icons d-flex justify-content-center">
                  ...
                  <a href="https://www.instagram.com/bunny_gaurav/" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faInstagram} size="2x" className="instagram" />
                  </a>
                </div>
              </div>
            ...
            <div className="col-11 col-lg-4 mx-auto my-5">
              <div className="card pb-4 hvr-buzz-out">
                ...
                <div className="team-icons d-flex justify-content-center">
                  <a href="https://www.linkedin.com/in/rukaiyak/" target="_blank" rel="noopener noreferrer"                    >
                    <FontAwesomeIcon icon={faLinkedin} size="2x" className="linkedin" />
                  </a>
                  <a href="https://www.instagram.com/rukaiyak_/" target="_blank" rel="noopener noreferrer"                    >
                    <FontAwesomeIcon icon={faInstagram} size="2x" className="instagram" />
                  </a>
                  <a href="https://twitter.com/ruk_____" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faTwitter} size="2x" className="twitter" />
                  </a>
                </div>
              </div>
            ...
            <div className="col-11 col-lg-4 mx-auto my-5">
              <div className="card pb-4 hvr-buzz-out">
                <img src={Snehashis} alt="alt" className="mx-auto img-fluid rounded-circle mb-2 mt-3 z-depth-1" />
                <div className="card-body py-3 px-0">
                ...
                <div className="team-icons d-flex justify-content-center">
                  <a href="https://www.linkedin.com/in/snehashis-pati-536bb81aa" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faLinkedin} size="2x" className="linkedin" />
                  </a>
                  <a href=" https://instagram.com/snehasish_pati?igshid=106xk4esdb4qx" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faInstagram} size="2x" className="instagram" />
                  </a>
                </div>
              </div>
            ...
            <div className="col-11 col-lg-4 mx-auto my-5">
              <div className="card pb-4 hvr-buzz-out">
                ...
                <div className="team-icons d-flex justify-content-center">
                  ...
                  <a href="https://www.instagram.com/_i.samar/" target="_blank" rel="noopener noreferrer"                    >
                    <FontAwesomeIcon
                      icon={faInstagram}
                      size="2x"
                      className="instagram"
            ...
            <div className="col-11 col-lg-4 mx-auto my-5">
              <div className="card pb-4 hvr-buzz-out">
                ...
                <div className="team-icons d-flex justify-content-center">
                  ...
                  <a href="https://www.instagram.com/_infynite_/" target="_blank" rel="noopener noreferrer"                    >
                    <FontAwesomeIcon icon={faInstagram} size="2x" className="instagram" />
                  </a>
                  <a href="https://twitter.com/yashrajjain726" target="_blank" rel="noopener noreferrer"                    >
                    <FontAwesomeIcon icon={faTwitter} size="2x" className="twitter" />
                  </a>
                </div>
              </div>
      ...
      <section id="team" className="my-4">
        <div className="container">
          ...
          <div className="row">
            <div className="col-11 col-lg-4 mx-auto my-5">
              <div className="card pb-4 hvr-buzz-out">
                <img src={Abhishek} alt="alt" className="mx-auto img-fluid rounded-circle mb-2 mt-3 z-depth-1" />
                <div className="card-body py-3 px-0">
