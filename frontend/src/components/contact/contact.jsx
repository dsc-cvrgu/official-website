    ...
    <div className="Contact">
      <div className="row">
        <div className="col col-md-8 col-sm-12 Contact_l">
          <h1>
            <span style={{ color: "#1A73EB" }}>Contact</span> DSC cgu
          </h1>
          <p>
          ...
          <p>
            ...
            efforts of many developers in and around Bhubaneswar to learn, share
            and get productive using the various Google products.
          </p>
